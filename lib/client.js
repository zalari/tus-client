...
var _uploadRequest = function(filepath, remoteFilename, offset) {
    ...
    //jetzt ist alles zu Ende gelesen...
    /*rs.on('end',function(){
...
/**
 * liefert die Checksumme für einen Bereich in einer Datei
 * @param filepath voller Pfad zur Datei die gehasht werden soll
 * @param start int Beginn in Bytes, ab dem die Checksumme gebildet werden soll
 * @param end int Ende in Bytes, bis zu dem die Checksumme gebildet werden soll
 * @param hashCipher
 * @returns Promise mit Hash als String
 * @private
 */
